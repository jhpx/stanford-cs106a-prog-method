...
public class DoubleBeepers extends SuperKarel {
    ...
    /*
     * For every beeper on the current corner, Karel places two beepers on the
     * corner immediately ahead of him.
     */
    ...
    /*
     * Place two beepers on corner one avenue ahead of Karel and move back to
    ...
    /*
     * Move all the beepers on the corner in front of Karel the the corner Karel
     * is currently on.
     */
    ...
    /*
     * Move one beeper from the current corner back one avenue and return to the
     * original position/orientation.
     */
    ...
    /*
     * Move Karel back one avenue, but have the same final orientation.
     */
