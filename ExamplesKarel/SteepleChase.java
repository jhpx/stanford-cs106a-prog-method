...
public class SteepleChase extends SuperKarel {
    ...
    /*
     * To run a race that is 9 avenues long, we need to move forward or jump
     * hurdles 8 times.
     */
    public void run() {
        for (int i = 0; i < 8; i++) {
    ...
    /*
     * Pre-condition: Facing East at bottom of hurdle Post-condition: Facing
     * East at bottom in next avenue after hurdle
     */
