...
public class PiApproximation extends ConsoleProgram {
    ...
    public void run() {
        ...
        /*
         * Note: area of circle = PI * r * r = PI * 1 * 1 = PI area of square =
         * side * side = 2 * 2 = 4 So, PI/4 is the fraction of darts landing in
         * circle: darts in circle = NDARTS * PI/4 PI = (4 * darts in
         * circle)/NDARTS
         */
